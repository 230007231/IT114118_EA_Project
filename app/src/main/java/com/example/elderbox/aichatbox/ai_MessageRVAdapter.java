...
public class ai_MessageRVAdapter extends RecyclerView.Adapter {
    ...
    // constructor class.
    public ai_MessageRVAdapter(ArrayList<ai_MessageModal> messageModalArrayList, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ai_user_msg, parent, false);
                return new UserViewHolder(view);
            case 1:
                // below line we are inflating bot message layout.
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ai_bot_msg, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ai_MessageModal modal = messageModalArrayList.get(position);
