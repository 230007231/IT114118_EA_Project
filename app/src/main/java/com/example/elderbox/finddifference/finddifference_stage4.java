...
public class finddifference_stage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finddifference_activity_stage4);
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (score >= 200) {
                    Intent intent = new Intent(finddifference_stage4.this, finddifference_score_page.class);
                    intent.putExtra("EXTRA_SCORE", score);
                    startActivity(intent);
                }else {
                    AlertDialog.Builder dlgAlert = new AlertDialog.Builder(finddifference_stage4.this);
