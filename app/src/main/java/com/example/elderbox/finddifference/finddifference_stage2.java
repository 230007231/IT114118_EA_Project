...
public class finddifference_stage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finddifference_activity_stage2);
...
// Set the initial score text in the score1 TextView
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (score >= 100) {
                    // Create an intent to start finddifference_stage3 activity
                    Intent intent = new Intent(finddifference_stage2.this, finddifference_stage3.class);
                    // Pass the score as an extra to the intent
                    intent.putExtra("EXTRA_SCORE", score);
                    // Start the activity
                    startActivity(intent);
                } else {
                    // Create an alert dialog to show hint message
                    AlertDialog.Builder dlgAlert = new AlertDialog.Builder(finddifference_stage2.this);
